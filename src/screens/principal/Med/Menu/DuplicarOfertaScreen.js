...
const DuplicarOfertaScreen = ({ route, navigation }) => {
        ...
        if (especialidad === undefined || especialidad === "") {
            ...
            try {
                ...
                await savePublicacion(
                    ...
                    .then((data) => {
                        Alert.alert(data, "Oferta duplicada!");
                        setIsLoading(false);
                        //navigation.goBack();
                    })
                    .catch((error) => {
                ...
                console.log(e);
                Alert.alert("Ocurrió un error al duplicar");
                setIsLoading(false);
            } finally {
...
export default DuplicarOfertaScreen;
