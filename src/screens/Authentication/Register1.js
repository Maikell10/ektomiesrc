    ...
    const handleCreateAccount = async () => {
        ...
        await firebase
            ...
            .then(async () => {
                ...
                user.providerData[0].picture = userFirebase.picture;
    ...
    return (
        <View style={styles.container}>
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            >
                                ...
                                >
                                    ¿Quieres ofrecer servicios de salud?
                                </Text>
                                <TouchableOpacity
                                    onPress={() =>
            ...
            <View style={{ width: "90%", marginBottom: 30 }}>
                <Text style={{ fontFamily: "Quicksand-Medium", fontSize: 13 }}>
